...
function displayQRCode({ txnId, origin, destination, amount }) {
    ...
    // Use a minimal payload to ensure QR fits in smallest version and avoid "Too long data" errors.
    // The transaction ID is unique so it's sufficient to identify the payment.
    const payload = String(txnId);
